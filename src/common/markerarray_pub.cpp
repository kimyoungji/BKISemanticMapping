...
namespace semantic_bki {
    ...
    MarkerArrayPub::MarkerArrayPub(ros::NodeHandle nh, std::string topic, float resolution) : nh(nh),
    ...
    void MarkerArrayPub::insert_point3d(float x, float y, float z, float min_z, float max_z, float size) {
    ...
    void MarkerArrayPub::clear_map(float size) {
      int depth = 0;
      if (size > 0)
        depth = (int) log2(size / 0.1);
    ...
    void MarkerArrayPub::insert_point3d_semantics(float x, float y, float z, float size, int c, int dataset) {
        geometry_msgs::Point center;
        center.x = x;
        center.y = y;
        center.z = z;
    ...
    void MarkerArrayPub::insert_point3d_variance(float x, float y, float z, float min_v, float max_v, float size, float var) {
        geometry_msgs::Point center;
        center.x = x;
        center.y = y;
        center.z = z;
    ...
    void MarkerArrayPub::insert_point3d(float x, float y, float z, float min_z, float max_z) {
        insert_point3d(x, y, z, min_z, max_z, -1.0f);
    }

    void MarkerArrayPub::insert_point3d(float x, float y, float z) {
        insert_point3d(x, y, z, 1.0f, 0.0f, -1.0f);
    }

    void MarkerArrayPub::insert_color_point3d(float x, float y, float z, double min_v, double max_v, double v) {
        geometry_msgs::Point center;
        center.x = x;
        center.y = y;
        center.z = z;
    ...
    void MarkerArrayPub::publish() const {
